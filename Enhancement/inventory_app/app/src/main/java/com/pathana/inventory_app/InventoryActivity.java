...
public class InventoryActivity extends AppCompatActivity {
    ...
    private TableRow getDisplayView(Shoe shoe){
        ...
        ImageView shoePicture = layout.findViewById(R.id.shoePic);
        Uri image = getImage(shoe.getImage());
        if (image != null)  shoePicture.setImageURI(image);
        row.addView(layout);
        return row;
    }
    ...
    private void checkPermissions(){
        checkPermission(Manifest.permission.SEND_SMS, "This app requires permission to send you SMS notifications.");
    }
    ...
    private Uri getImage(String img){
        try {
