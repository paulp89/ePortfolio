...
{	
	Vertex center = Vertex{ {X, Y, 0}, color, {0.f, 1.f}, { 1.f, 1.f, 1.f } };
	...
	for (int i = 0; i < sectors; ++i)
	{
		...
		Vertex left_vertex = Vertex{ {x, y, 0}, color, {-1.f, 0.f}, { 1.f, 0.f, 1.f } };
		
		x = std::get<0>(right) + X;
		y = std::get<1>(right) + Y;
		Vertex right_vertex = Vertex{ {x, y, 0}, color, {1.f, 0.f}, { 1.f, 0.f, 1.f } };
	...
	for (int i = 0; i < sectors; ++i)
	{
		...
		Vertex left_vertex_top = Vertex{ {x, y, height}, color, { 1.f, 1.f } , { 0.f, 1.f, 0.f } };

		x = std::get<0>(right) + X;
		y = std::get<1>(right) + Y;
		Vertex right_vertex = Vertex{ {x, y, 0},  color,  { 1.f, 0.f }, { 0.f, 1.f, 0.f } };
		Vertex right_vertex_top = Vertex{ {x, y, height},  color,  { 1.f, 0.f }, { 0.f, 1.f, 0.f } };
		/*
			top right
			bottom right
			bottom left
	...
	if (top) {
		...
		for (int i = 0; i < sectors; ++i)
		{
			float x = std::get<0>(left) + X;
			float y = std::get<1>(left) + Y;
			Vertex left_vertex = Vertex{ {x, y, height}, color };
